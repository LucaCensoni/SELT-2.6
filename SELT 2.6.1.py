...
Descrizione:
  Questo codice è finalizzato alla ricerca automatica di serbatoi attraverso
  l'interrogazione di un file DTM. Viene applicato sul software QGIS mediante
  la sua interfccia PyQgis, è necessairio scaricare il plugin SAGA Next Generatio


Copyright (c) 2024 Luca Censoni
"""
